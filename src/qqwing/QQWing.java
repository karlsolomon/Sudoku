...
public class QQWing {
	...
	public static void generateSudokuPuzzle(int difficulty){
		String diff;
		switch (difficulty) {
			case 1: diff = "easy";
				break;
			case 2: diff = "intermediate";
				break;
			case 3: diff = "expert";
				break;
			default: diff = "simple";
		...
		try {
			...
			System.setOut(new PrintStream(puzzle));
		} catch (Exception e) {
			e.printStackTrace();
		}
		QQWingMain.main(new String[] {"--generate", "--solution", "--one-line", "--difficulty" , diff});
		System.setOut(stdout);
		System.out.println("made puzzle");
	}
